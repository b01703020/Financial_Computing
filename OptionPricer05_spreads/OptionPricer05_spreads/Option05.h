...
namespace fre
{
    ...
    class bull_spread : public EurOption
    {
        private:
            double K1;
            double K2;
        public:
            bull_spread(int N_, double K1_, double K2_) : EurOption(N_), K1(K1_), K2(K2_){}
            ~bull_spread() {}
            double Payoff(double z) const;
    };

    class bear_spread : public EurOption
    {
        private:
            double K1;
            double K2;
        public:
            bear_spread(int N_, double K1_, double K2_) : EurOption(N_), K1(K1_), K2(K2_){}
            ~bear_spread() {}
            double Payoff(double z) const;
    };
